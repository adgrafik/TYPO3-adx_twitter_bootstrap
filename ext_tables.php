...
if (version_compare(TYPO3_branch, '6.0.0', '>=')) {
	\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile($_EXTKEY, 'Configuration/TypoScript/DeviceVisibility/6.0.0/', 'ad: Bootstrap content device visibility');
}
...
$tempColumns = array(
	'tx_adxtwitterbootstrap_offset' => array(
		...
		'config' => array(
			'type' => 'user',
			'default' => '0,0,0,0',
			'userFunc' => 'AdGrafik\AdxTwitterBootstrap\UserFunc\Tca->getSpanColumnFieldsExpert',
		),
	),
	...
	'tx_adxtwitterbootstrap_image_column_span' => array(		
		'label' => 'LLL:EXT:adx_twitter_bootstrap/Resources/Private/Language/locallang_db.xlf:tx_adxtwitterbootstrap_image_columns',
		'exclude' => 1,		
		'config' => array(
			'type' => 'user',
			'default' => '0,0,0,0',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addFieldsToPalette('tt_content', 'frames', '--linebreak--,tx_adxtwitterbootstrap_offset,--linebreak--,tx_adxtwitterbootstrap_span,--linebreak--,tx_adxtwitterbootstrap_link_content_element', 'after:section_frame');
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addFieldsToPalette('tt_content', 'imageblock', 'tx_adxtwitterbootstrap_image_column_span', 'replace:imagecols');
...
if (\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::isLoaded('powermail')) {
	...
	$TCA['tx_powermail_domain_model_forms']['palettes']['layout'] = array(
		'showitem' => 'css,--linebreak--,tx_adxtwitterbootstrap_offset,--linebreak--,tx_adxtwitterbootstrap_span',
		'canNotCollapse' => TRUE,
	);
	...
	$TCA['tx_powermail_domain_model_pages']['palettes']['layout'] = array(
		'showitem' => 'css,tx_adxtwitterbootstrap_layout,tx_adxtwitterbootstrap_hide_legend,--linebreak--,tx_adxtwitterbootstrap_offset,tx_adxtwitterbootstrap_offset_breakpoint,--linebreak--,tx_adxtwitterbootstrap_span,tx_adxtwitterbootstrap_span_breakpoint,tx_adxtwitterbootstrap_clear,--linebreak--,tx_adxtwitterbootstrap_label_to_field_ratio,tx_adxtwitterbootstrap_label_to_field_ratio_breakpoint',
		'canNotCollapse' => TRUE,
	);
