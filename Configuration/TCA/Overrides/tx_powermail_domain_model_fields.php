...
if ($extensionConfiguration['extensions.']['activatePowermail'] && \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::isLoaded('powermail')) {
	...
	// Add placeholder for backward compatibility.
	if (version_compare($versionPowermail, '2.0', '=')) {
		$tempColumns['tx_adxtwitterbootstrap_placeholder'] = array(
	...
	$GLOBALS['TCA']['tx_powermail_domain_model_fields']['palettes']['apperance'] = array(
	...
	if ($extensionConfiguration['components.']['activateDatepicker']) {
		...
		$GLOBALS['TCA']['tx_powermail_domain_model_fields']['palettes']['datepicker'] = array(
	...
	\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addToAllTCAtypes('tx_powermail_domain_model_fields', '--div--;LLL:EXT:adx_twitter_bootstrap/Resources/Private/Language/locallang_db_powermail.xlf:tx_powermail_domain_model_forms.palette.apperance,--palette--;LLL:EXT:adx_twitter_bootstrap/Resources/Private/Language/locallang_db_powermail.xlf:tx_powermail_domain_model_forms.palette.apperance;apperance', '', 'after:own_marker_select');
