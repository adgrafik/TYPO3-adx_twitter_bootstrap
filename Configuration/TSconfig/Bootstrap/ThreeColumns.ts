 ...
 * tx_gridelements
 */
tx_gridelements.setup.tx_adxtwitterbootstrap_threecolumns {

	title = LLL:EXT:adx_twitter_bootstrap/Resources/Private/Language/locallang_db.xlf:TSconfig.threeColumns.title
	description = LLL:EXT:adx_twitter_bootstrap/Resources/Private/Language/locallang_db.xlf:TSconfig.threeColumns.description
	flexformDS = FILE:EXT:adx_twitter_bootstrap/Configuration/FlexForm/Bootstrap/ThreeColumns.xml
